#ifndef SENTRY_NAV_BT_RELIABLE_NAVIGATE_TO_POSE_HPP_
#define SENTRY_NAV_BT_RELIABLE_NAVIGATE_TO_POSE_HPP_
...
#endif  // SENTRY_NAV_BT_RELIABLE_NAVIGATE_TO_POSE_HPP_
