...
class TeammateFrameConverter : public rclcpp::Node {
 public:
  TeammateFrameConverter() : Node("teammate_frame_converter") {
    ...
    declare_parameter("red.origin_x", 0.0);
    declare_parameter("red.origin_y", 0.0);
    declare_parameter("red.origin_yaw", 0.0);
    declare_parameter("blue.origin_x", 0.0);
    declare_parameter("blue.origin_y", 0.0);
    declare_parameter("blue.origin_yaw", 0.0);

    odom_frame_id_ = get_parameter("odom_frame_id").as_string();

    red_origin_x_ = get_parameter("red.origin_x").as_double();
    red_origin_y_ = get_parameter("red.origin_y").as_double();
    red_origin_yaw_ = get_parameter("red.origin_yaw").as_double();
    blue_origin_x_ = get_parameter("blue.origin_x").as_double();
    blue_origin_y_ = get_parameter("blue.origin_y").as_double();
    blue_origin_yaw_ = get_parameter("blue.origin_yaw").as_double();
